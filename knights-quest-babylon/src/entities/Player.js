...
export class Player {
  ...
  createKnight() {
    ...
    material.emissiveColor = new BABYLON.Color3(baseColor.r * 0.5, baseColor.g * 0.5, baseColor.b * 0.5);
    ...
    limbMat.emissiveColor = new BABYLON.Color3(0.36, 0.28, 0.22);
    ...
    armorMat.emissiveColor = new BABYLON.Color3(baseColor.r * 0.35, baseColor.g * 0.35, baseColor.b * 0.35);
